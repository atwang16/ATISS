...
def main(argv):
    parser = argparse.ArgumentParser(description="Pickle the 3D Future dataset")
    ...
    parser.add_argument(
        "--path_to_invalid_bbox_jids", default="../config/black_list.txt", help="Path to objects that ae blacklisted"
    )
    parser.add_argument(
    ...
    output_path = "{}/threed_future_model_{}.pkl".format(args.output_directory, room_type)
